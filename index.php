...
<html lang="en">
  <head>
    ...
    <link
      rel="icon"
      type="image/x-icon"
      href="assets/icons/two-dices-alt.svg"
    />
  ...
  <body>
          ...
          <div class="row d-none" id="bid">
            <div class="col">
              <button
                ...
                onclick="moreValue('bid1', 'bid-image-1');"
              >
              ...
              <button
                class="btn btn-primary"
                onclick="lessValue('bid1', 'bid-image-1');"
              >
            ...
            <div class="col">
              <button
                class="btn btn-primary"
                onclick="moreValue('bid2', 'bid-image-2');"
              >
                <i class="fa-solid fa-angle-up"></i>
              </button>
              ...
              <button
                class="btn btn-primary"
                onclick="lessValue('bid2', 'bid-image-2');"
              >
                <i class="fa-solid fa-angle-down"></i>
              </button>
            </div>
    ...
    <!-- Font Awesome Icons -->
    <script
      src="https://kit.fontawesome.com/79f56e797f.js"
      crossorigin="anonymous"
    ></script>
